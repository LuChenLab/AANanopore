...
mclapply(1:nrow(meta), function(i) {
  ...
  # saveRDS(Current, file = paste0("./analysis/11.SignalIdentification/Jan02/MixAA/SignalCurrent_", meta[i, paste0(amino_acid, "_", file_name)], ".Rds"))
  saveRDS(abf, file = paste0("./analysis/11.SignalIdentification/Jan02/MixAA/ABF_", meta[i, paste0(amino_acid, "_", file_name)], ".Rds"))
  fwrite(Sigs, file = paste0("./analysis/11.SignalIdentification/Jan02/MixAA/RawSignal_", meta[i, paste0(amino_acid, "_", file_name)], ".txt"), sep = "\t", row.names = F, quote = F)
}, mc.cores = 6)
