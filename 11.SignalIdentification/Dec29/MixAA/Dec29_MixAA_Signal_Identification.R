...
mclapply(1:nrow(meta), function(i) {
  ...
  # saveRDS(Current, file = paste0("./analysis/11.SignalIdentification/Dec29/MixAA/SignalCurrent_", meta[i, paste0(amino_acid, "_", file_name)], ".Rds"))
  saveRDS(abf, file = paste0("./analysis/11.SignalIdentification/Dec29/MixAA/ABF_", meta[i, paste0(amino_acid, "_", file_name)], ".Rds"))
  fwrite(Sigs, file = paste0("./analysis/11.SignalIdentification/Dec29/MixAA/RawSignal_", meta[i, paste0(amino_acid, "_", file_name)], ".txt"), sep = "\t", row.names = F, quote = F)
}, mc.cores = 4)
...
mclapply(1:nrow(meta), function(i) {
  print(i)
  abf <- readRDS(file = paste0("./analysis/11.SignalIdentification/Dec29/MixAA/ABF_", meta[i, paste0(amino_acid, "_", file_name)], ".Rds"))
  Sigs <- fread(file = paste0("./analysis/11.SignalIdentification/Dec29/MixAA/RawSignal_", meta[i, paste0(amino_acid, "_", file_name)], ".txt"))
