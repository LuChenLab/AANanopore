...
```{r}
data <- aaBlockade[A != "CMC", .(Class, AminoAcid = A, BlockadeMean, BlockadeSD, Blockade, Volume = V)]
openxlsx::write.xlsx(data, "./analysis/00.FigureTables/Rebuttal/Nov12/Figures/Data/Fig2B.xlsx")
```
