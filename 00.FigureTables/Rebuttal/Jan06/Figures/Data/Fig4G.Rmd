...
Sigs <- Sigs[SignalCurrentPercent > 80, .(AminoAcid = AA, File = A, StartTime, EndTime, Blockade, DwellTime, Density = D)]
```

```{r}
openxlsx::write.xlsx(Sigs, "./analysis/00.FigureTables/Rebuttal/Jan06/Figures/Data/Fig4G.xlsx")
```
