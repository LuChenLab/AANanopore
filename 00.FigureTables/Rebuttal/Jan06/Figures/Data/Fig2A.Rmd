...
```{r}
data <- SigSumm[, .(Class, AminoAcid = A, BlockadeMean, BlockadeSD, Blockade = paste(round(BlockadeMean, 3), "±", round(BlockadeSD, 4)))]
openxlsx::write.xlsx(data[, 1:4], "./analysis/00.FigureTables/Rebuttal/Jan06/Figures/Data/Fig2A.xlsx", overwrite = T)
```
