...
```{r}
Sigs <- Sigs[(AA == "AcK + K" & Blockade > 0.149 & Blockade < 0.27) | AA != "AcK + K"]
Sigs <- Sigs[, .(AminoAcid = AA, File = A, StartTime, EndTime, Blockade, DwellTime, Density = D)]
```

```{r}
openxlsx::write.xlsx(Sigs, "./analysis/00.FigureTables/Rebuttal/Jan06/Figures/Data/Fig4H.xlsx")
```
