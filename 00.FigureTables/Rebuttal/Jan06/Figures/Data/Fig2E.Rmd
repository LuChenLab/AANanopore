...
Sigs1 <- Sigs1[A != "CMC"]
setnames(DwellTime, "A", "AminoAcid")
DwellTime[, AA := NULL]
```

```{r eval=FALSE}
# openxlsx::write.xlsx(list(Sigs1[, .(AminoAcid = A, Class, File = file_id, ID, Blockade, DwellTime)], DwellTime), "./analysis/00.FigureTables/Rebuttal/Jan06/Figures/Data/Fig2E.xlsx")
openxlsx::write.xlsx(list(Sigs1[, .(AminoAcid = A, Class, DwellTime)], DwellTime[, .(Class, AminoAcid, half.life, half.life_Std.Error)]), "./analysis/00.FigureTables/Rebuttal/Jan06/Figures/Data/Fig2E.xlsx", overwrite = T)
```
