...
```{r}
openxlsx::write.xlsx(cutoffList[Dataset %in% c("Validation")], 
                     file = "./analysis/00.FigureTables/Oct23/Figure3/Fig3c.xlsx")
```
...
```{r}
openxlsx::write.xlsx(cM, file = "./analysis/00.FigureTables/Oct23/Figure3/Fig3d.xlsx")
```
...
```{r}
openxlsx::write.xlsx(cM, "./analysis/00.FigureTables/Oct23/Figure3/Fig3d.xlsx")
```
