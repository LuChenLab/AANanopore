...
meta[, sg_files := paste0("./analysis/82.ABFProcessing/SelectedL0/", file_id, ".MainL0.txt")]
...
```{r}
sig0 <- sig0[!file_id %in% c("21326001.1", "21420005.1")]
sig1 <- sig1[!file_id %in% c("21326001.1", "21420005.1")]
```
...
nrow(sig0)
nrow(sig1)
fwrite(sig0, paste0("analysis/82.ABFProcessing/SelectedSignals/", aat, "_background.txt"), sep = "\t", quote = F)
fwrite(sig1, paste0("analysis/82.ABFProcessing/SelectedSignals/", aat, "_signal.txt"), sep = "\t", quote = F)
```
...
```{r}
# sig0 <- sig0[!file_id %in% c("21326001.1", "21420005.1")]
sig1 <- sig1[!file_id %in% c("21501004.1", "21501005.1")]
```
...
```{r}
# sig0 <- sig0[!file_id %in% c("21326001.1", "21420005.1")]
sig1 <- sig1[!file_id %in% c("21201008.1")]
```
...
```{r}
# sig0 <- sig0[!file_id %in% c("21326001.1", "21420005.1")]
sig1 <- sig1[!file_id %in% c("21703003.1", "21703002.1")]
```
...
```{r}
sig0 <- sig0[!file_id %in% c("21419023.1")]
sig1 <- sig1[!file_id %in% c("21419024.1", "21327003.1", "21327004.1")]
```
...
```{r}
# sig0 <- sig0[!file_id %in% c("21419023.1")]
sig1 <- sig1[!file_id %in% c("21324007.1", "21324008.1")]
```
...
```{r}
sig0 <- sig0[!file_id %in% c("21315045.1")]
# sig1 <- sig1[!file_id %in% c("21324007.1", "21324008.1")]
```
...
```{r}
# sig0 <- sig0[!file_id %in% c("21315045.1")]
sig1 <- sig1[!file_id %in% c("21303003.1")]
```
...
```{r}
sig0 <- sig0[!file_id %in% c("21419019.1")]
sig1 <- sig1[!file_id %in% c("21419019.2")]
```
