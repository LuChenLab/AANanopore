...
saveRDS(dist, file = "./analysis/87.LimitOfDetection/02.SignalsDistance/Gly_correlation_distance_knn.Rds")

dist = stats::dist(FeatureMatrix, method = "euclidean")
dist <- dbscan::kNN(dist, k = 20)
saveRDS(dist, file = "./analysis/87.LimitOfDetection/02.SignalsDistance/Gly_euclidean_distance_knn.Rds")
