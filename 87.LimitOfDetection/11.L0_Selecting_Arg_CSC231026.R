...
meta <- as.data.table(openxlsx::read.xlsx("data/ChenShanchuan/20231026/20231026_Arg.xlsx", sheet = 1))
meta <- meta[实验目的 == "精氨酸浓度梯度" & grepl("20231026_", 文件名)]
...
meta[, concentration := gsub("R精氨酸（", "", sample)]
...
outdir <- file.path("analysis/87.LimitOfDetection/01.SelectedL0")
