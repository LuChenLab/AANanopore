...
par(mfrow = c(1, 2))
hist(do.call(rbind, BUBs)$pA, probability = T, breaks = 50, xlab = "Current of BUB", main = "Histogram of BUB current")
hist(do.call(c, mclapply(BUBs, function(x) x[L != "B", 1 - pA/(x[L == "B", mean2(pA)])], mc.cores = 10)), 
     probability = T, breaks = 50, xlab = "Blockade of BUB", main = "Histogram of BUB blockade")
```
...
```{r fig.width=10, fig.height=4}
par(mfrow = c(1, 2))
hist(BUB_Tab[, pA], probability = TRUE, breaks = 50, xlab = "Current of BUB", main = "Histogram of BUB current")
...
```{r fig.width=10, fig.height=5}
ggplot(Summ[Blockade < 0.15, ], aes(Blockade, color = File)) +
  geom_line(stat = "density") + 
  labs(x = "Blockade of L1") + 
