...
```{r fig.width=12, fig.height=6}
phe[Time > 24.12653 & Time < 24.18522, plot(Time, pA, type = "s")]
phe[Time > 24.12653 & Time < 24.18522, lines(Time, Sm, type = "s", col = "red")]
```
...
```{r}
saveRDS(object = BUB2, file = "/mnt/raid61/Personal_data/tangchao/AANanopore/analysis/01.AASignalRecognition/ZhangMing20210402/phe/21303003_BUB.Rds")
```

```{r}
BUB2 <- readRDS("/mnt/raid61/Personal_data/tangchao/AANanopore/analysis/01.AASignalRecognition/ZhangMing20210402/phe/21303003_BUB.Rds")
```
