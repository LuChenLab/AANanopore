...
phe[1:115000, plot(Time, pA, type = "s")]
phe[1:115000, lines(Time, Sm, type = "s", col = "red")]
```
...
```{r warning=FALSE}
DenSm <- density(do.call(rbind, BUB2)[Sm < L1Min & Sm >= 20, Sm], adjust = 1)
...
```{r fig.width=12, fig.height=6}
Tab <- BUB2[[which(names(BUB2) == "010")[6]]]
Tab <- BUB2[[which(names(BUB2) == "01210")[2]]]
