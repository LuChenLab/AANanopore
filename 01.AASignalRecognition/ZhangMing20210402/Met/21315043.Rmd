...
```{r warning=FALSE}
DenSm <- density(do.call(rbind, BUB2)[Sm < L0Min & Sm >= 40, Sm], adjust = 4)
...
```{r}
breks <- diff(range(L1_B1B[, (BaseMedian - Lev1Median)/BaseMedian]))/0.005
hist(L1_B1B[, (BaseMedian - Lev1Median)/BaseMedian], breaks = 5)
```
