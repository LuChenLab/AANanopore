...
mclapply(seq_len(nrow(meta1)), function(i) {
  if(file.exists(paste0("./analysis/01.AASignalRecognition/Version9/01.SignalPolish/Group2/", meta1[i, file_name], ".Rds"))) return(NULL)
  ...
  saveRDS(abf, paste0("./analysis/01.AASignalRecognition/Version9/01.SignalPolish/Group2/", meta1[i, file_name], ".Rds"))
}, mc.cores = 2)
