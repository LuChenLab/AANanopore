...
mclapply(seq_len(nrow(meta)), function(i) {
  ...
  abf <- readRDS(paste0("./analysis/01.AASignalRecognition/Version9/01.SignalPolish/Group2/", meta[i, file_name], ".Rds"))
  ...
  BUB <- BUB[Wid > 0.00075]
  saveRDS(BUB, paste0("./analysis/01.AASignalRecognition/Version9/03.BUBSignal/Group2/", meta[i, file_name], "_BUB.Rds"))
}, mc.cores = 10)
