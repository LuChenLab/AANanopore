...
```{r}
files <- list.files("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Sig_Summa.Rds")
```

```{r}
Sig_Summa <- readRDS("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Sig_Summa.Rds")
```
...
if(nrow(bgsignals) > 0) {
  ...
  Big_FeatureMatrix <- list.files(path = "./analysis/21.ABFProcessing/04.PolypeptideSequencing/PolypeptideFYSL/FeatureMatrix", B_file, full.names = TRUE)
...
saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Signals_euclidean_distance.Rds"))
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Signals_euclidean_distance.Rds")
...
select_sigs_RemoveOutlier_Run1 <- RemoveOutlier(tree = res.hc, n = 200, Keep = 0.6)
...
fwrite(Selected_sigs, "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Selected_sigs.txt", sep = "\t", quote = F)
```
...
```{r}
ggplot(sgsignals_curt[File == "21o19001"], aes(x = Blockade, y = DwellTime, colour = Within)) + 
...
Fit1 <- readRDS("./analysis/62.MachineLearning/01.ModelTraining/ModelEFHLSY/model.Rds")
...
fwrite(Selected_sigs2, "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideFYSL/Selected_sigs_summary.txt", sep = "\t", quote = F)
```
