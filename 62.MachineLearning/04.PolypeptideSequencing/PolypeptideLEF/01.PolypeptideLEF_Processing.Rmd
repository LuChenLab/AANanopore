...
#                   outdir = "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF", 
...
```{r}
files <- list.files("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Sig_Summa.Rds")
```

```{r}
Sig_Summa <- readRDS("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Sig_Summa.Rds")
```
...
if(nrow(bgsignals) > 0) {
  ...
  Big_FeatureMatrix <- list.files(path = "./analysis/21.ABFProcessing/04.PolypeptideSequencing/PolypeptideLEF/FeatureMatrix", B_file, full.names = TRUE)
...
saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Signals_euclidean_distance.Rds"))
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Signals_euclidean_distance.Rds")
...
fwrite(Selected_sigs, "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Selected_sigs.txt", sep = "\t", quote = F)
```
...
Fit1 <- readRDS("./analysis/62.MachineLearning/01.ModelTraining/ModelEFL/model.Rds")
...
fwrite(Selected_sigs2, "./analysis/62.MachineLearning/04.PolypeptideSequencing/PolypeptideLEF/Selected_sigs_summary.txt", sep = "\t", quote = F)
```
