...
meta[, product := gsub(" ", "", product)]
```

```{r}
meta[grepl("LWQSTDE", product), ]
meta <- meta[file_name == "20230321_003"]
```

```{r}
AA_Run1 <- AMINO_ACID_CODE[strsplit("LWQSTDE", "")[[1]]]
```
...
BaseMeanFiltering(SigFile = sg_files[1], starttime = 10.5, endtime = 32.00, target = "LWQSTDE", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/20230321_003", 
...
```{r}
files <- list.files("./analysis/62.MachineLearning/02.MixtureAA/20230321_003", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Sig_Summa.Rds")
```

```{r}
Sig_Summa <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Sig_Summa.Rds")
```
...
saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Signals_euclidean_distance.Rds"))
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Signals_euclidean_distance.Rds")
...
fwrite(Selected_sigs, "./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Selected_sigs.txt", sep = "\t", quote = F)
```
...
fwrite(Selected_sigs2, "./analysis/62.MachineLearning/02.MixtureAA/20230321_003/Selected_sigs_summary.txt", sep = "\t", quote = F)
```
