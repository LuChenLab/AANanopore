...
```{r}
AA_Run1 <- c("Ala", "Ile", "Pro")
AA_Run2 <- c("Ala", "Ile", "Pro", "Thr", "Gln", "Trp")
AA_Run3 <- c("Ala", "Ile", "Pro", "Thr", "Gln", "Trp", "Ser", "Leu", "CbC")
AA_Run4 <- c("Ala", "Ile", "Pro", "Thr", "Gln", "Trp", "Ser", "Leu", "CbC", "Lys", "His")
```
...
bg_files <- grep(pattern = "20230804_0011", files, value = T)
sg_files <- files[!grepl(pattern = "20230804_0011", files)]

BaseMeanFiltering(SigFile = bg_files, starttime = 2.94, endtime = 8.64, outdir = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", target = "Background")
BaseMeanFiltering(SigFile = sg_files[1], starttime = 0, endtime = 15.00, target = "Run1", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", 
                  product = as.numeric(AABlockade[AA %in% AA_Run1, Blockade]))

BaseMeanFiltering(SigFile = sg_files[2], starttime = 0, endtime = 12.00, target = "Run2", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", 
                  product = as.numeric(AABlockade[AA %in% AA_Run2, Blockade]))

BaseMeanFiltering(SigFile = sg_files[3], starttime = 0, endtime = 15.00, target = "Run3", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", 
                  product = as.numeric(AABlockade[AA %in% AA_Run3, Blockade]))

BaseMeanFiltering(SigFile = sg_files[4], starttime = 0, endtime = 18.26, target = "Run4", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", 
...
```{r}
files <- list.files("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/Sig_Summa.Rds")
```
...
lapply(paste0("Run", 1:4), function(x) {
  ...
  saveRDS(FeatureMatrix, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/", x, "_Signals_FeatureMatrix.Rds"))
})

mclapply(paste0("Run", 1:4), function(x) {
  FeatureMatrix <- readRDS(paste0("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/", x, "_Signals_FeatureMatrix.Rds"))
  spearmanCor = cor(t(FeatureMatrix), method = "spearman")
  spearmanCor <- as.dist(1 - spearmanCor)
  saveRDS(spearmanCor, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/", x, "_Signals_spearman_correlation.Rds"))
}, mc.cores = 4)

mclapply(paste0("Run", 1:4), function(x) {
  FeatureMatrix <- readRDS(paste0("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/", x, "_Signals_FeatureMatrix.Rds"))
  euclidean = stats::dist(FeatureMatrix, method = "euclidean")
  saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/", x, "_Signals_euclidean_distance.Rds"))
}, mc.cores = 4)
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/Run1_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run2_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/Run2_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run3_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/Run3_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run4_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/WZC20230804/Rep4/Run4_Signals_euclidean_distance.Rds")
...
select_sigs_RemoveOutlier_Run1 <- RemoveOutlier(tree = res.hc, n = 3, Keep = 0.9)
...
```{r}
select_sigs <- c(select_sigs_RemoveOutlier_Run1, select_sigs_RemoveOutlier_Run3, select_sigs_RemoveOutlier_Run4)
