...
bg_files <- grep(pattern = "20230824_0012", files, value = T)
sg_files <- files[!grepl(pattern = "20230824_0012", files)]

outdir <- file.path("./analysis/62.MachineLearning/02.MixtureAA/CSC20230824/Rep1")

BaseMeanFiltering(SigFile = bg_files, starttime = 0, endtime = 5.5, outdir = outdir, target = "Background")

BaseMeanFiltering(SigFile = sg_files[1], starttime = 0, endtime = 11.5, target = "Run1", 
                  outdir = outdir, 
                  product = as.numeric(AABlockade[AA %in% AA_Run1, Blockade]))

BaseMeanFiltering(SigFile = sg_files[1], starttime = 12, endtime = 24.0, target = "Run2", 
                  outdir = outdir, 
                  product = as.numeric(AABlockade[AA %in% AA_Run2, Blockade]))

BaseMeanFiltering(SigFile = sg_files[2], starttime = 0, endtime = 11.5, target = "Run3", 
                  outdir = outdir, 
                  product = as.numeric(AABlockade[AA %in% AA_Run3, Blockade]))

BaseMeanFiltering(SigFile = sg_files[2], starttime = 12, endtime = 24, target = "Run4", 
                  outdir = outdir, 
                  product = as.numeric(AABlockade[AA %in% AA_Run4, Blockade])) # 基线波动

# BaseMeanFiltering(SigFile = sg_files[3], starttime = 0, endtime = 20, target = "Run5", 
#                   outdir = outdir, 
#                   product = as.numeric(AABlockade[AA %in% AA_Run5, Blockade])) # 基线波动太严重了
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/CSC20230824/Rep1/Run1_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run2_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/CSC20230824/Rep1/Run2_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run3_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/CSC20230824/Rep1/Run3_Signals_euclidean_distance.Rds")
...
```{r fig.width=24, fig.height=6}
Run4_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/CSC20230824/Rep1/Run4_Signals_euclidean_distance.Rds")
