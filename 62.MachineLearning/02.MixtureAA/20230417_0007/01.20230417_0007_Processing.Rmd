...
meta <- meta[file_name == "20230417_0007"]
meta
```
...
BaseMeanFiltering(SigFile = sg_files[1], starttime = 0, endtime = 20, target = "LWQSTIFNDE", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/20230417_0007", 
...
```{r}
files <- list.files("./analysis/62.MachineLearning/02.MixtureAA/20230417_0007", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/02.MixtureAA/20230417_0007/Sig_Summa.Rds")
```
...
saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/20230417_0007/Signals_euclidean_distance.Rds"))
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/20230417_0007/Signals_euclidean_distance.Rds")
...
fwrite(Selected_sigs, "./analysis/62.MachineLearning/02.MixtureAA/20230417_0007/Selected_sigs.txt", sep = "\t", quote = F)
```
...
Fit1 <- readRDS(paste0("./analysis/62.MachineLearning/01.ModelTraining/Model", paste(sort(names(AA_Run1)), collapse = ""), "/model.Rds"))
...
fwrite(Selected_sigs2, "./analysis/62.MachineLearning/02.MixtureAA/20230417_0007/Selected_sigs_summary.txt", sep = "\t", quote = F)
```
