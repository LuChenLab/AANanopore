...
meta <- meta[file_name == "20230418_0008"]
meta
```

```{r}
AA_Run1 <- AMINO_ACID_CODE[strsplit("LWQSTIFN", "")[[1]]]
```
...
BaseMeanFiltering(SigFile = sg_files[1], starttime = 0, endtime = 11, target = "LWQSTIFN", 
                  outdir = "./analysis/62.MachineLearning/02.MixtureAA/20230418_0008", 
...
```{r}
files <- list.files("./analysis/62.MachineLearning/02.MixtureAA/20230418_0008", "MainL0.txt", full.names = T, recursive = T)
...
saveRDS(Sig_Summa, file = "./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Sig_Summa.Rds")
```

```{r}
Sig_Summa <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Sig_Summa.Rds")
```
...
saveRDS(euclidean, file = paste0("./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Signals_euclidean_distance.Rds"))
```
...
Run1_dist <- readRDS("./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Signals_euclidean_distance.Rds")
...
fwrite(Selected_sigs, "./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Selected_sigs.txt", sep = "\t", quote = F)
Selected_sigs <- fread("./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Selected_sigs.txt")
```
...
fwrite(Selected_sigs2, "./analysis/62.MachineLearning/02.MixtureAA/20230418_0008/Selected_sigs_summary.txt", sep = "\t", quote = F)
```
