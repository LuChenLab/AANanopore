...
outdir <- paste0("./analysis/81.ABFProcessing/SelectedSignals/01.StandardAA/03.TrainModels/Model", i, ".L12.Rds")
...
FMs <- mclapply(FMfs, fread, mc.cores = 10)
FMs <- do.call(rbind, FMs)
if(!all(Sigs$ID0 %in% FMs$ID)) stop()
