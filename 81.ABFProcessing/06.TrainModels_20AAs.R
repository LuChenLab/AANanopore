...
load(file = gsub("Rds$", "RData", outdir))
rm(list = c("Sigs_Test_FM", "Sigs_Train_Upsample", "Sigs_Test"))
set.seed(825)
Fit1 <- train(Class ~ ., data = Sigs_Train_Upsample_FM, 
              # preProc = c("center", "scale", "YeoJohnson", "nzv"),
              method = "naive_bayes", 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
saveRDS(Fit1, gsub(".Rds", ".NB.Rds", outdir))
...
Fit1 <- train(Class ~ ., data = Sigs_Train_Upsample_FM, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
saveRDS(Fit1, gsub(".Rds", ".NNet.Rds", outdir))
...
Fit1 <- train(Class ~ ., data = Sigs_Train_Upsample_FM, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
saveRDS(Fit1, gsub(".Rds", ".knn.Rds", outdir))
...
Fit1 <- train(Class ~ ., data = Sigs_Train_Upsample_FM, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
saveRDS(Fit1, gsub(".Rds", ".CART.Rds", outdir))
...
Fit1 <- train(Class ~ ., data = Sigs_Train_Upsample_FM, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
saveRDS(Fit1, gsub(".Rds", ".AdaBoost.Rds", outdir))
