...
meta <- meta0[amino_acid == "LSGV"]
meta <- meta[!file_id %in% c("22402004", "22402005")]
...
saveRDS(dist, file = "./analysis/89.Neoantigen/02.SignalDistance/LSGV_spearman_distance_knn.Rds")

dist = stats::dist(FeatureMatrix, method = "euclidean")
dist <- dbscan::kNN(dist, k = 20)
saveRDS(dist, file = "./analysis/89.Neoantigen/02.SignalDistance/LSGV_euclidean_distance_knn.Rds")
