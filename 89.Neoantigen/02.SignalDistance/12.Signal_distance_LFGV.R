...
saveRDS(dist, file = "./analysis/89.Neoantigen/02.SignalDistance/LFGV_spearman_distance_knn.Rds")

dist = stats::dist(FeatureMatrix, method = "euclidean")
dist <- dbscan::kNN(dist, k = 20)
saveRDS(dist, file = "./analysis/89.Neoantigen/02.SignalDistance/LFGV_euclidean_distance_knn.Rds")
