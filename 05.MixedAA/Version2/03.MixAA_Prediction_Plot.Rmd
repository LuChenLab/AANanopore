...
files <- list.files("./analysis/05.MixedAA/Version2/02.SignalPrediction", full.names = TRUE)
```
...
ggplot(Sig_Res, aes(x = Blockade, y = DwellTime, colour = AA)) + 
  ...
  theme_bw(base_size = 15) + 
  theme(legend.position = "none")
ggsave("./analysis/05.MixedAA/Version2/03.Plot/Cutoff4_Scatters.pdf", width = 10, height = 10)
```
