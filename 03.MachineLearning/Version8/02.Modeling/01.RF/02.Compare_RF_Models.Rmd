...
```{r}
Modeling_Datas <- list.files("./analysis/03.MachineLearning/Version8/01.DataPreparation", "Modeling_Data", full.names = T)
Models <- list.files("./analysis/03.MachineLearning/Version8/02.Modeling/01.RF/01.Models", "Rds", full.names = T)
```
...
```{r}
openxlsx::write.xlsx(cutoffList, "analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/cutoffList.xlsx")
saveRDS(Preds, file = "analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/Preds.Rds")
```
...
ggsave("analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/Cutoff_Recovery_Accuracy.pdf", width = 9, height = 6)
```
...
ggsave("analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/Prediction_Probability_Distribution.pdf", width = 16, height = 6)
```
...
ggsave("analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/Prediction_Probability_Distribution2.pdf", width = 16, height = 6)
```
...
ggsave("./analysis/03.MachineLearning/Version8/02.Modeling/01.RF/02.CompareModels/Cutoff4_ValidationUp_confusionMatrix.pdf", width = 7, height = 7)
```
