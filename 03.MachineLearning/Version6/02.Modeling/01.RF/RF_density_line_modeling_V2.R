...
AAInfo <- AAInfo[AllTime > 1 & SignalSD < 4]
...
save(Train, Test, up_Test, Valid, up_Valid, file = "./analysis/03.MachineLearning/01.data/Version6/Modeling_Data_2.RData")
save(Train, file = "./analysis/03.MachineLearning/01.data/Version6/Train_Data_2.RData")
...
Fit2 <- train(Class ~ ., data = Train, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
save(Fit2, file = "./analysis/03.MachineLearning/Version6/02.Modeling/01.RF/01.Models/RF_Fit2.RData")
stopCluster(cl)

ROC_Test <- predict(Fit2, up_Test, type = "prob")
...
ROC_Valid <- predict(Fit2, Valid, type = "prob")
...
ROC_Valid_up <- predict(Fit2, up_Valid, type = "prob")
