...
AAInfo <- AAInfo[AllTime > 3 & SignalSD < 4]
...
save(Train, Test, up_Test, Valid, up_Valid, file = "./analysis/03.MachineLearning/01.data/Version6/Modeling_Data_4.RData")
save(Train, file = "./analysis/03.MachineLearning/01.data/Version6/Train_Data_4.RData")
...
Fit4 <- train(Class ~ ., data = Train, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
save(Fit4, file = "./analysis/03.MachineLearning/Version6/02.Modeling/01.RF/01.Models/RF_Fit4.RData")
stopCluster(cl)

ROC_Test <- predict(Fit4, up_Test, type = "prob")
...
ROC_Valid <- predict(Fit4, Valid, type = "prob")
...
ROC_Valid_up <- predict(Fit4, up_Valid, type = "prob")
