...
AAInfo <- AAInfo[AllTime > 2 & SignalSD < 4]
...
save(Train, Test, up_Test, Valid, up_Valid, file = "./analysis/03.MachineLearning/01.data/Version6/Modeling_Data_3.RData")
save(Train, file = "./analysis/03.MachineLearning/01.data/Version6/Train_Data_3.RData")
...
Fit3 <- train(Class ~ ., data = Train, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
save(Fit3, file = "./analysis/03.MachineLearning/Version6/02.Modeling/01.RF/01.Models/RF_Fit3.RData")
stopCluster(cl)

ROC_Test <- predict(Fit3, up_Test, type = "prob")
...
ROC_Valid <- predict(Fit3, Valid, type = "prob")
...
ROC_Valid_up <- predict(Fit3, up_Valid, type = "prob")
