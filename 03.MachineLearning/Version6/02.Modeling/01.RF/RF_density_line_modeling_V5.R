...
AAInfo <- AAInfo[AllTime > 4 & SignalSD < 4]
...
save(Train, Test, up_Test, Valid, up_Valid, file = "./analysis/03.MachineLearning/01.data/Version6/Modeling_Data_5.RData")
save(Train, file = "./analysis/03.MachineLearning/01.data/Version6/Train_Data_5.RData")
...
Fit5 <- train(Class ~ ., data = Train, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
save(Fit5, file = "./analysis/03.MachineLearning/Version6/02.Modeling/01.RF/01.Models/RF_Fit5.RData")
stopCluster(cl)

ROC_Test <- predict(Fit5, up_Test, type = "prob")
...
ROC_Valid <- predict(Fit5, Valid, type = "prob")
...
ROC_Valid_up <- predict(Fit5, up_Valid, type = "prob")
