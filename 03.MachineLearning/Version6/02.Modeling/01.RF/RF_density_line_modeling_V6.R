...
AAInfo <- AAInfo[AllTime > 5 & SignalSD < 4]
...
save(Train, Test, up_Test, Valid, up_Valid, file = "./analysis/03.MachineLearning/01.data/Version6/Modeling_Data_6.RData")
save(Train, file = "./analysis/03.MachineLearning/01.data/Version6/Train_Data_6.RData")
...
Fit6 <- train(Class ~ ., data = Train, 
              ...
              metric = "Accuracy", 
              allowParallel = TRUE)
save(Fit6, file = "./analysis/03.MachineLearning/Version6/02.Modeling/01.RF/01.Models/RF_Fit6.RData")
stopCluster(cl)

ROC_Test <- predict(Fit6, up_Test, type = "prob")
...
ROC_Valid <- predict(Fit6, Valid, type = "prob")
...
ROC_Valid_up <- predict(Fit6, up_Valid, type = "prob")
