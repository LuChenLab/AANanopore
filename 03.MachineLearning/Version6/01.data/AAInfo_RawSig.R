...
AAInfo <- na.omit(AA)
# AAInfo <- AAInfo[amino_acid != "Cys"]
# AAInfo <- AAInfo[amino_acid != "Pro"]

RawSig <- do.call(rbind, BUBs)[L == "U"]
RawSig <- RawSig[ID %in% AAInfo$ID]

save(AAInfo, RawSig, file = "./analysis/03.MachineLearning/01.data/Version6/AAInfo_RawSig.RData")
