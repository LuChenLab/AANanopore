...
lapply(1:6, function(i) {
  ...
  save(Train, Test, up_Test, Valid, up_Valid, file = paste0("./analysis/03.MachineLearning/Version9/01.DataPreparation/Modeling_Data_", i, ".RData"))
  save(Train, file = paste0("./analysis/03.MachineLearning/Version9/01.DataPreparation/Train_Data_", i, ".RData"))
})
```
...
```{r}
lapply(1:6, function(i) {
  load(paste0("./analysis/03.MachineLearning/Version9/01.DataPreparation/Train_Data_", i, ".RData"))
  set.seed(825)
  RFC <- train(Class ~ ., data = Train, 
                ...
                metric = "Accuracy", 
                allowParallel = TRUE)
  saveRDS(RFC, file = paste0("./analysis/03.MachineLearning/Version9/02.Modeling/01.RF/01.Models/RF_Fit", i, ".Rds"))
})
stopCluster(cl)
```
