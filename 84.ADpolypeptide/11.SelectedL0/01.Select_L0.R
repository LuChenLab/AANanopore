...
meta <- meta[!file_id %in% gsub(".MainL0.txt", "", list.files("analysis/84.ADpolypeptide/11.SelectedL0"))]

outdir <- file.path("analysis/84.ADpolypeptide/11.SelectedL0")
# i = 1
BaseMeanFiltering(SigFile = meta[i, sg_files], starttime = meta[i, start_time], endtime =5, target = meta[i, file_id], outdir = outdir, 
