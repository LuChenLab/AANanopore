...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/84.ADpolypeptide/12.SignalDistance/LVFAK_all_sigs_distance.Rds"))
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/84.ADpolypeptide/13.SelectedSignals/LVFAK.selected.signals.txt"), sep = "\t", quote = F)
```
