...
```{r}
xlsxfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".xlsx", full.names = TRUE)[7:9]
Signalsfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".Rds", full.names = TRUE)[7:9]
```
...
files <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1/02.SignalPrediction", full.names = TRUE)[3:5]
```
...
Polypeptide1_iden$MinPP <- apply(Polypeptide1_iden[, .(RF, KNN, CART)], 1, min)
Polypeptide1_iden$MeanPP <- apply(Polypeptide1_iden[, .(RF, KNN, CART)], 1, mean)
Polypeptide1_iden3 <- copy(Polypeptide1_iden)
```


```{r}
Polypeptide1_iden <- rbind(Polypeptide1_iden1, Polypeptide1_iden2, Polypeptide1_iden3)
```
