...
```{r}
xlsxfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".xlsx", full.names = TRUE)[3:5]
Signalsfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".Rds", full.names = TRUE)[3:5]
```
...
lapply(seq_along(xlsxfiles), function(i) {
  ...
  save(Mat, file = paste0("./analysis/02.PolypeptideSequencing/20220314/Version1/01.SignalTransform/", gsub(".xlsx", ".RData", basename(xlsxfiles[i]))))
})
```
...
```{r}
files <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1/01.SignalTransform", ".RData", full.names = TRUE)[3:5]
```
...
lapply(seq_along(files), function(j) {
  ...
  save(Polypeptide1_iden, Polypeptide1_RF, Polypeptide1_KNN, Polypeptide1_CART, file = paste0("./analysis/02.PolypeptideSequencing/20220314/Version1/02.SignalPrediction/", basename(files[j])))
})
```
...
```{r}
xlsxfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".xlsx", full.names = TRUE)[6]
Signalsfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".Rds", full.names = TRUE)[6]
```
...
```{r}
files <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1/01.SignalTransform", ".RData", full.names = TRUE)[6]
```
