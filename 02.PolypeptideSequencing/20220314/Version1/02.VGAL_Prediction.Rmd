...
```{r}
xlsxfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".xlsx", full.names = TRUE)[1:2]
Signalsfiles <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1", ".Rds", full.names = TRUE)[1:2]
```
...
```{r}
files <- list.files("./analysis/02.PolypeptideSequencing/20220314/Version1/01.SignalTransform", ".RData", full.names = TRUE)
```
