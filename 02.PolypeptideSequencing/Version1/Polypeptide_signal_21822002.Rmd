...
```{r}
File <- "./data/ZhangMing_20210822/21822002.abf"
StartTime <- 0.2
EndTime <- 24.8
...
```{r eval=FALSE}
phe <- rbind(phe[Time > 12.95 * 60 & Time < 14.52 * 60, ], 
             phe[Time > 15.6 * 60 & Time < 18.4 * 60, ], 
             phe[Time > 20 * 60 & Time < 24 * 60, ])
```
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/Version1/AAs_Signal_21822002.xlsx")
```
