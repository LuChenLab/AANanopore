...
```{r}
File <- "./data/ZhangMing_20210822/21822009.abf"
# StartTime <- 1.4
# EndTime <- 24.9
...
```{r eval=FALSE}
phe <- rbind(phe[Time > 0 * 60 & Time < 12 * 60, ], 
             phe[Time > 14.2 * 60 & Time < 24.9 * 60, ])
```
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/Version1/AAs_Signal_21822009.xlsx")
```
