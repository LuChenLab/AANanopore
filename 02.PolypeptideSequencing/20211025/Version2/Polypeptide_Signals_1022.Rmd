...
meta <- meta[date == "1022" & amino_acid != "blank" & !file_name %in% c("21o22007", "21o22008", "21o22010", "21o22012")]
...
mclapply(seq_len(nrow(meta)), function(f) {
  ...
  File <- paste0("./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/", filename, ".abf")
...
```{r}
hist(SigTab[TimeRatio > 0.8 & DwellTime > 0.5 & SignalSD < 2, Blockade], breaks = 100)
```
