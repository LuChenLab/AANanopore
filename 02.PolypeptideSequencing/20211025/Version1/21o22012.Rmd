...
```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22012.abf"
StartTime <- 19
EndTime <- 24.9
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22012.xlsx")
```
