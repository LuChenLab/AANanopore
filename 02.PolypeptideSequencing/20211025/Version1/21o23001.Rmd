...
```{r}
File <- "./data/ZhangMing_20211025/1023-Ang2/21o23001.abf"
StartTime <- 2
EndTime <- 24.9
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o23001.xlsx")
```
