...
```{r}
File <- "./data/ZhangMing_20211025/1023-Ang2/21o23003.abf"
StartTime <- 0.5
EndTime <- 11.5
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o23003.xlsx")
```
