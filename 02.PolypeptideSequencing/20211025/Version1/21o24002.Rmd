...
```{r}
File <- "./data/ZhangMing_20211025/1024-Ang3/21o24002.abf"
StartTime <- 0
EndTime <- 7.5
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o24002.xlsx")
```
