...
```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22001.abf"
StartTime <- 2.2
EndTime <- 13.5
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22001.xlsx")
```
