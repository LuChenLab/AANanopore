...
```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22008.abf"
StartTime <- 0.5
EndTime <- 7
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22008.xlsx")
```
