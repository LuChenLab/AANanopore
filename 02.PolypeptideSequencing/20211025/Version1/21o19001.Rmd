...
```{r}
File <- "./data/ZhangMing_20211019/21o19001.abf"
StartTime <- 12.2
EndTime <- 24.5
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o19001.xlsx")
```
