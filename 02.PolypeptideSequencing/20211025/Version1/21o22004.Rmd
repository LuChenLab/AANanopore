...
```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22004.abf"
StartTime <- 0
EndTime <- 24.9
...
```{r}
DenSm <- density(phe[, Sm], adjust = 0.7)
L0 <- L0Coor(DenSm)
L0Min <- min(L0) * 0.9
```
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22004.xlsx")
```
