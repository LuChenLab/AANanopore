...
meta <- meta[date != "1019"]
meta[-(1:5), .(file_name, date, `start_time.(min)`, `end_time.(min)`, baseline_mean)]
```

```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22007.abf"
StartTime <- 0
EndTime <- 24.9
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22007.xlsx")
```
