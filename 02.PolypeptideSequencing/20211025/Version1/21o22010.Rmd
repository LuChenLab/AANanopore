...
```{r}
File <- "./data/ZhangMing_20211025/1022-ACTHx3 Ang1+1/21o22010.abf"
StartTime <- 0
EndTime <- 1.7
...
```{r}
DenSm <- density(phe[, Sm], adjust = 1.5)
L0 <- L0Coor(DenSm, d = 108.3)
L0Min <- min(L0) * 0.9
```
...
```{r}
openxlsx::write.xlsx(BinBUB3, "./analysis/02.PolypeptideSequencing/20211025/Version1/AAs_Signal_21o22010.xlsx")
```
