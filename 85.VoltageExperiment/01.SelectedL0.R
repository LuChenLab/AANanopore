...
meta <- fread("./data/MetaInfomation/Voltage_Experiment_Meta.txt")
...
meta <- meta[!file_id %in% gsub(".MainL0.txt", "", list.files("analysis/85.VoltageExperiment/SelectedL0"))]

outdir <- file.path("analysis/85.VoltageExperiment/SelectedL0")
# i = 1
