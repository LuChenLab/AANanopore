...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231031_0007.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231031_0007.1"], dists = alldists, k = 10, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("S", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231031_0007.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```

## 20231031_0008.1

```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231031_0008.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231031_0008.1"], dists = alldists, k = 10, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("S", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231031_0008.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```

## 20231031_0012.1

```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231031_0012.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231031_0012.1"], dists = alldists, k = 10, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("S", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231031_0012.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```

## 20231031_0014.1

```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231031_0014.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231031_0014.1"], dists = alldists, k = 10, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("S", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231031_0014.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/SerPTM_euclidean_distance_knn.Rds"))
sigs <- KnnSelecting(signals = dataset, dists = alldists, k = 10, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("S", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/SerPTM_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
