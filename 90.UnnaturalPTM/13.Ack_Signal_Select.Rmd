...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231027_0017.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231027_0017.1"], dists = alldists, k = 10, noise = 1, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("K", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231027_0017.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231027_0018.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231027_0018.1"], dists = alldists, k = 10, noise = 1, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("K", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231027_0018.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231027_0025.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231027_0025.1"], dists = alldists, k = 10, noise = 1, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("K", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231027_0025.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/20231027_0026.1.signal.dist.Rds"))
sigs <- KnnSelecting(signals = dataset[A == "20231027_0026.1"], dists = alldists, k = 10, noise = 1, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("K", ""))], Blockade])
```
...
```{r}
sigs <- RemoveOutlier(tree = res.hc, n = 10, Keep = 0.88)
ggplot(dataset[ID %in% sigs], aes(x = Blockade, y = DwellTime, colour = ID %in% sigs)) + 
  geom_point(size = .5) + 
  scale_y_log10() + 
  scale_colour_manual(values = "#E41A1C") + 
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/20231027_0026.1_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
...
```{r fig.width=24, fig.height=6}
alldists <- readRDS(file.path("./analysis/90.UnnaturalPTM/02.SignalsDistance/AcK_euclidean_distance_knn.Rds"))
sigs <- KnnSelecting(signals = dataset, dists = alldists, k = 15, noise = 1, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("K", ""))], Blockade])
```
...
```{r}
fwrite(dataset[ID %in% sigs], file.path("./analysis/90.UnnaturalPTM/03.SelectedSignals/AcK_euclidean_distance_knn_selected.signals.txt"), sep = "\t", quote = F)
```
