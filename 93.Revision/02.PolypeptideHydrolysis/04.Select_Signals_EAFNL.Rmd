...
```{r}
dist1 <- readRDS("./analysis/93.Revision/02.PolypeptideHydrolysis/03.SignalDistance/2023_12_26_0009.1_spearman_distance_knn.Rds")
```

```{r fig.width=18, fig.height=4}
sig1 <- KnnSelecting(signals = Sigs1[A == "2023_12_26_0009.1"], dists = dist1, k = 20, noise = 0, index = AABlockade[AA %in% AMINO_ACID_CODE[unlist(strsplit("EAFNL", ""))], Blockade])
```
