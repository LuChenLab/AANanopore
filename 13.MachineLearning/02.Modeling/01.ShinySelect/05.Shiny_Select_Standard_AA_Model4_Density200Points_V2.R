...
saveRDS(Train, "./analysis/13.MachineLearning/01.DataPreparation/01.ShinySelect/Model4/Train2.Rds")
...
Train <- readRDS("./analysis/13.MachineLearning/01.DataPreparation/01.ShinySelect/Model4/Train2.Rds")
set.seed(825)
RFC <- train(Class ~ ., data = Train, 
             ...
             metric = "Accuracy", 
             allowParallel = TRUE)
saveRDS(RFC, file = "./analysis/13.MachineLearning/01.DataPreparation/01.ShinySelect/Model4/RF_Fit2.Rds")
