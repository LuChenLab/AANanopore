...
saveRDS(dist, file = "./analysis/91.RealTimeHydrolysis/02.SignalDistance/euclidean_distance_knn.Rds")


mclapply(sig0[, unique(A)], function(x) {
  print(x)
  outfile <- paste0("./analysis/91.RealTimeHydrolysis/02.SignalDistance/", x)
