...
saveRDS(dist, file = "./analysis/91.RealTimeHydrolysis/32.SignalDistance/euclidean_distance_knn.Rds")


mclapply(sig0[, unique(A)], function(x) {
  outfile <- paste0("./analysis/91.RealTimeHydrolysis/32.SignalDistance/", x)
