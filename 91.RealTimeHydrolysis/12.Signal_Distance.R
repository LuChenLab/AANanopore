...
saveRDS(dist, file = "./analysis/91.RealTimeHydrolysis/12.SignalDistance/spearman_distance_knn.Rds")

dist = stats::dist(FeatureMatrix, method = "euclidean")
dist <- dbscan::kNN(dist, k = 20)
saveRDS(dist, file = "./analysis/91.RealTimeHydrolysis/12.SignalDistance/euclidean_distance_knn.Rds")
